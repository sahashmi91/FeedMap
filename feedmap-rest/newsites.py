...
ACCESS_TOKEN = "CAALENzASkUUBAJlIytExlZBzec8DVJjNqkmUarw48oZBkw6ObZBHZCnmzwmhGCtLnwkowpSE30EfoQbqN900roXgpu2mXTWkIEp9OOfibjVQ2zMgze6GCfXmbIU35jAfhm5lAlHCgZCZB8sbrriDW8pCVBZATOGyshwbtjoQumbNvYnntRoV0OvEqhszRsVxewIZAqfDS21ahkBChudLctwQ"
...
def facebookScrapper():
    ...
    for page in pageList:
        ...
        print response
        news= jsonResponse['data'][0]['message']
    ...
    for news in newsList:
        ...
        for word in news.split(' '):
		   ...
		   writeToDB(city, source, headline)
